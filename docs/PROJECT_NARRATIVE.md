...
2. Run or open the build artifact for graffitti-rhino-unrealengine and interact with the primary experience.
...
## Progress
- Latest commit: 2d88fd9 (2026-03-02) - docs: add professional README with badges
- Total commits: 5
...
3d shapes and structures, dynamic forms, textured forms, apply 3D texture to walls, use unreal engine for visualization (scale and file compatibility)
## Documentation & Proof
